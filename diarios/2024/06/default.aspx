...
<body class="body">
    <form method="post" action="default.aspx?dts=02%2f06%2f2024" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="6O+iALKWCK1KXk6sZB7Re7UXNgw/EvagUBjugRoSIr/PIFbBcj85Ba67nmNl/Khh0s3lJYKn/uZP9aL3OJmwPzyHB/TGH9EE3+16OefJZDpDtKUo5dupncdJC0VzhD5xT3XtpE5xzqS6FaIIw54WOfuc7je2wLBiHjBM8m+SIVs=" />
...
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="8gbKT3pO6mFLWYddxiIydRZhT8dwjk9H2pRckOEas2xWBYuw0Ofyzwp5Vyl6BNF/N6YKsl+ax/g4Ag8zm1MJUkydb9KtyJCgFpHg3opVzO2s0ymwCZJndC+PBe2mNTnnDsdRwhAYNJFcDxBsvmh7/Q==" />
            ...
            <div id="top">
                ...
                <div style="float: left; font-size: 28px; font-family: Tahoma; padding-top: 6px">
                    ...
                    <div style="float: right; padding: 8px 0px 0px 0px">
                        <input name="datepicker" type="text" value="30/05/2024" id="datepicker" class="form-control input-sm" />
                    </div>
                </div>
            </div>
                ...
                <div id="Panel1">
                    ...
                    <div style="text-align: center; width: 100%">
                        <div class="alert alert-danger" style="padding: 5px 0px 0px 0px; width: 250px; margin: 5px auto 0px auto">
                            <strong>
                                <span id="Label1">02/06/2024</span></strong> Diário não encontrado.
                        </div>
                    </div>
